    ...
    await supabase.from('pricing_rules').upsert(
      [
        ...
        },
        {
          ...
          tier: 'elite',
          base_rate_guard: 900,
          armed_multiplier: 1.6,
          vehicle_rate_suv: 1800,
          vehicle_rate_armored: 3600,
          min_hours: 4,
        },
        {
          city: 'GDL',
          tier: 'direct',
          base_rate_guard: 600,
          armed_multiplier: 1.4,
          vehicle_rate_suv: 1300,
          vehicle_rate_armored: 2600,
          min_hours: 4,
        },
        {
          city: 'MTY',
          tier: 'corporate',
          base_rate_guard: 1100,
          armed_multiplier: 1.7,
          vehicle_rate_suv: 2200,
          vehicle_rate_armored: 4400,
          min_hours: 4,
        },
      ],
