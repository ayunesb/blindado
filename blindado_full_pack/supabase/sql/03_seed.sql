-- 03_seed.sql
-- Demo client & guard profiles (use your existing Auth UIDs if present)
insert into public.profiles (id, role, first_name, last_name, phone_e164, email, kyc_status)
values
  ('1b387371-6711-485c-81f7-79b2174b90fb', 'client', 'Demo', 'Client', '+5215555555551', 'client@demo.com', 'verified')
on conflict (id) do nothing;

insert into public.profiles (id, role, first_name, last_name, phone_e164, email, kyc_status)
values
  ('c38efbac-fd1e-426b-a0ab-be59fd908c8c', 'guard', 'Juan', 'Guard', '+5215555555552', 'guard@demo.com', 'verified')
on conflict (id) do nothing;
...
-- Basic pricing rule for CDMX/direct
